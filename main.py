...
while True: # 무한히 반복
    ...
    for i1 in range(len(n1_list)):
        ...
        if keys[pygame.K_d] and p1 == 0: # d키를 눌렀을떄 p1이 0인 경우
            if m1.y >= 400 and m1.y < 600: # y좌표 400~599까지의 좌표인 경우
                d_list.append(i1) # 삭제 리스트에 올리기
    d_list.reverse()
    for d in d_list:
    ...
    for i2 in range(len(n2_list)):
        ...
        if keys[pygame.K_f] and p2 == 0: # f키를 눌렀을떄 p2이 0인 경우
            if m2.y >= 400 and m2.y < 600: # y좌표 400~599까지의 좌표인 경우
                d_list.append(i2) # 삭제 리스트에 올리기
    d_list.reverse()
    for d in d_list:
    ...
    for i3 in range(len(n3_list)):
        ...
        if keys[pygame.K_j] and p3 == 0: # j키를 눌렀을떄 p3이 0인 경우
            if m3.y >= 400 and m3.y < 600: # y좌표 400~599까지의 좌표인 경우
                d_list.append(i3) # 삭제 리스트에 올리기
    d_list.reverse()
    for d in d_list:
    ...
    for i4 in range(len(n4_list)):
        ...
        if keys[pygame.K_k] and p4 == 0: # k키를 눌렀을떄 p4이 0인 경우
            if m4.y >= 400 and m4.y < 600: # y좌표 400~599까지의 좌표인 경우
                d_list.append(i4) # 삭제 리스트에 올리기
    d_list.reverse()
    for d in d_list:
